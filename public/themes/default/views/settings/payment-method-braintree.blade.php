<flare-payment-method-braintree :user="user" :team="team" :billable-type="billableType" inline-template>
    <div>
        <!-- Current Discount -->
        ...
        <!-- Update Card -->
        @include('flare::settings.payment-method.update-payment-method-braintree')
...
</flare-payment-method-braintree>

...
class CreateFreshApiToken
{
    ...
    {
        return Flare::usesApi() && $this->requestShouldReceiveFreshToken($request) &&
    ...
    /**
     * Determine if the given response already contains a Flare API token.
     *

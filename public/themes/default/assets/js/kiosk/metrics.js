module.exports = {
    ...
    methods: {
         ...
         */
        getRevenue() {
            this.$http.get('/flare/kiosk/performance-indicators/revenue')
                .then(response => {
         ...
         */
        getPlans() {
            this.$http.get('/flare/kiosk/performance-indicators/plans')
                .then(response => {
         ...
         */
        getTrialUsers() {
            this.$http.get('/flare/kiosk/performance-indicators/trialing')
                .then(response => {
        ...
        getPerformanceIndicators() {
            this.$http.get('/flare/kiosk/performance-indicators')
                .then(response => {
        ...
        drawCurrencyChart(id, days, dataGatherer) {
            return this.drawChart(id, days, dataGatherer, value =>
                Vue.filter('currency')(value.value, Flare.currencySymbol)
            );
        },

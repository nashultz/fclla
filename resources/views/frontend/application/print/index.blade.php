...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-6 col-lg-offset-3">
            <p>Business Name: <hr></p>
            <p>Your Name\s: <hr></p>
            <p>Mailing Address: <hr></p>
            <div class="col-lg-4">
                <p>Business Phone: <hr></p>
            </div>
            <div class="col-lg-4">
                <p>Home: <hr></p>
            </div>
            ...
            <p>Email Address: <hr></p>
            <br>
            <p>How many properties (units) you currently own: <hr></p>
            <p>Is this membership a renewal: <hr></p>
            <p>Would you like to be included on a Membership Roster with your contact information that would be available to other members? <hr></p>
